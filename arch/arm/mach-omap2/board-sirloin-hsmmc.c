/*
 * arch/arm/mach-omap2/board-sirloin-hsmmc.c
 *
 * Copyright (C) 2013 Peter
 *
 * linux/arch/arm/mach-omap2/board-sholes-hsmmc.c
 *
...
extern int sirloin_wifi_status(int irq);
#ifdef CONFIG_MMC_EMBEDDED_SDIO
extern int sirloin_wifi_status_register(void (*callback)(int card_present,
						void *dev_id), void *dev_id);
#endif

static int hsmmc2_card_detect(int irq)
{
	return sirloin_wifi_status(irq);
}
#endif
...
static struct omap_mmc_platform_data mmc1_data = {
	...
	.slots[0] = {
		...
		.card_detect_irq	= 0,
		.card_detect            = NULL,//hsmmc_card_detect,
	},
};
...
static struct embedded_sdio_data sirloin_wifi_emb_data = {
	.cis    = {
		.vendor         = 0x104c,
		.device         = 0x9066,
		.blksize        = 512,
...
#ifdef CONFIG_MMC_EMBEDDED_SDIO
		.embedded_sdio		= &sirloin_wifi_emb_data,
		.register_status_notify	= &sirloin_wifi_status_register,
#endif
	},
};
#endif
...
void __init sirloin_hsmmc_init(void)
{
